...
export const MainInfo = ():React.ReactElement => {
  return (
    <div className='flex flex-col justify-center items-center gap-4 py-4 px-8 md:px-12 '>
      <h2 className=' text-3xl font-semibold text-emerald-600 self-start text-center md:text-left'>Muchos contactos que registrar?</h2>
